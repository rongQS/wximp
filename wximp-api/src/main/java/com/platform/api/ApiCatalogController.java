...
public class ApiCatalogController extends ApiBaseAction {
    ...
    @IgnoreAuth
    @RequestMapping("firstLevelCategory")
    public Object firstLevelCatalog(@LoginUser UserVo loginUser) {
        Map<String, Object> resultObj = new HashMap<String, Object>();
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("parent_id", 0);
        List<CategoryVo> queryList = categoryService.queryList(params);
        
        resultObj.put("firstLevelCategory", queryList);
        return toResponsSuccess(resultObj);
    }
}